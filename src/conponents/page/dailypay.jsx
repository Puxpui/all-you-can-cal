...
import { savelistprice, calculateTotal, clearsave } from './calculator/dailycal';

function DailyPay() {
  return (
    <Layout>
      <div className='flex justify-center font-ctfont font-semibold w-90 text-gray-700'>
        <div className='flex justify-center absolute mr-60'>
          <p className='mb-2 text-sm mt-20'>รายการสินค้า</p>
        </div>
        ...
        <div className='absolute mt-[15%] bg-base-100 bg-opacity-55 rounded-lg w-[30%] h-[50%]'>
          <p className='p-4 pb-0 flex justify-center'>รายการสินค้าทั้งหมด</p>
          <div className="relative pt-4 pb-2">
            <div id='listshow' className="absolute left-[10%]"></div>
            <div id='priceshow' className="absolute right-[10%]"></div>
          </div>
          <div id='lasttotal' className="flex justify-center mt-[55%] text-lg font-bold"></div>
